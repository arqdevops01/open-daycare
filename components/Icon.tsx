...
const ICONS = {
  ...
  home: {
    children: <path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z" />,
  },
  users: {
    children: (
      <>
  ...
  heart: {
    children: <path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21.2l7.8-7.8 1-1a5.5 5.5 0 0 0 0-7.8z" />,
    fill: "#E0654A",
  },
  comment: {
...
export function Icon({ name, fill, className, ...props }: IconProps) {
  const icon = ICONS[name];
  return (
    <svg
      viewBox="0 0 24 24"
      fill={fill ?? icon.fill ?? "none"}
      stroke="currentColor"
